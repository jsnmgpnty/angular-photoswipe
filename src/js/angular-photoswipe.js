...
ngPhotoSwipe.directive('photoSwipe', ['$rootScope', function ($rootScope) {
    var template =
    ...
    var initPhotoSwipeFromDOM = function (gallerySelector) {
        ...
        var openPhotoSwipe = function (index, galleryElement, disableAnimation) {
            ...
            gallery.listen('shareLinkClick', function (e, target) {
                ...
                $rootScope.$broadcast('PS_SHARE_LINK_CLICK', target.getAttribute('id'), gallery.options.getTextForShare(), gallery.options.getImageURLForShare());
